var C = {
  ...
  EXPIRES: 365,
  HISTORY_PAGE_PREFIX: 'bdsft_webrtc_page_',
...
C.standard = [C.R_960x720,C.R_640x480,C.R_320x240];
C.WIDESCREEN_RESOLUTIONS = C.widescreen = {
  '1280 x 720': C.R_1280x720,
  '640 x 360': C.R_640x360,
  '320 x 180': C.R_320x180
};
C.widescreen = [C.R_1280x720,C.R_640x360,C.R_320x180];
