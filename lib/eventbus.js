...
function EventBus() {
	...
	self.getUserMediaFailed = function() {
		self.emit('getUserMediaFailed', {});
	};
	self.invalidDestination = function() {
		self.emit('invalidDestination', {});
	};
	self.emptyDestination = function() {
		self.emit('emptyDestination', {});
	};
